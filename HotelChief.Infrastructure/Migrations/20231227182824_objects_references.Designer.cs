...
namespace HotelChief.Infrastructure.Migrations
{
    ...
    [Migration("20231227182824_objects_references")]
    partial class objects_references
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HotelChief.Core.Entities.HotelServiceOrder", b =>
                {
                    ...
                    b.Property<int?>("HotelServiceServiceId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("HotelServiceServiceId");
            ...
            modelBuilder.Entity("HotelChief.Core.Entities.HotelServiceOrder", b =>
                {
                    b.HasOne("HotelChief.Core.Entities.Employee", null)
                        .WithMany()
                    ...
                    b.HasOne("HotelChief.Core.Entities.HotelService", null)
                        .WithMany()
                    ...
                    b.HasOne("HotelChief.Core.Entities.HotelService", "HotelService")
                        .WithMany()
                        .HasForeignKey("HotelServiceServiceId");
            ...
            modelBuilder.Entity("HotelChief.Core.Entities.Reservation", b =>
                {
                    b.HasOne("HotelChief.Core.Entities.Room", null)
                        .WithMany()
